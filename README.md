...
### 1. 작품 기록 및 관리 (Advanced!)
- ✅ 작품 등록: 이미지 업로드, 제목, 작가, 감상평, 평점(5점 만점) 기록
- ✅ 화풍(Style) 저장: 인상주의, 표현주의 등 작품의 스타일을 별도로 기록
- ✅ 지능형 태그 시스템: [작품/공간/경험] 계층 구조를 가진 3단계 태그 기능 (최대 5개)
- ✅ 작품 수정/삭제: 등록한 작품의 모든 데이터 수정 및 삭제 (서버 동기화)
...
- ✅ 센터 정렬 수치: 마이 페이지의 작품/팔로워/팔로잉 수치를 직관적으로 가운데 정렬
